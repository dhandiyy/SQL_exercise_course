-- MEMBUAT TABLE 
-- daftar table: employees, suppliers, locations dan shops
-- ========================================================
...
CREATE TABLE employees(
	...
	email VARCHAR(30),
	hire_date DATE,
	gender CHAR(1), -- tipe data hanya menerima opsi yang disediakan
	salary INT,
	coffeeshop_id INT -- akan menjadi FK untuk table shops
);
...
CREATE TABLE shops(
	...
	city_id INT, -- akan menjadi FK untuk table locations
	PRIMARY KEY (coffeeshop_id)
);

-- Edit table employee untuk membuat FK pada kolom coffeeshop_id
ALTER TABLE employees
ADD FOREIGN KEY (coffeeshop_id) REFERENCES shops(coffeeshop_id)
ON DELETE SET NULL; -- ketika record di parent table deleted, record set to null di child table

--- Membuat table locations
...
-- Edit table shops untuk membuat FK pada kolom city_id
ALTER TABLE shops
ADD FOREIGN KEY (city_id) REFERENCES locations(city_id)
ON DELETE SET NULL;

-- Membuat table suppliers
CREATE TABLE suppliers(
	coffeeshop_id INT,
    supplier_name VARCHAR(50),
    coffee_type VARCHAR(20),
    PRIMARY KEY (coffeeshop_id, supplier_name), -- ini adalah composite key
	FOREIGN KEY (coffeeshop_id) REFERENCES shops(coffeeshop_id)
	ON DELETE CASCADE -- row pada child table akan terhapus jika row pada parent table dihapus
);



-- INPUT DATA AWAL KE TIAP TABEL
-- ========================================================
...
-- update nilai pada tabel yang memiliki FK
...
-- Data selanjutnya pada tiap tabel akan copy and paste dari sumber project yang sudah disediakan
